<div class="relative flex flex-col items-center text-start text-black">
                            
    <p class="mb-10 sm:w-80 w-60 text-center">{{GoogleTranslate::trans("In a time of crisis it is normal to:",session()->get('locale'))}}</p>
