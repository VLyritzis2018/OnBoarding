@section('title','Guidance Teens Tips')
    ...
    @endphp
        ...
        <div class="relative flex items-center flex-col w-4/5 h-[90vh] mainColor my-7">
            ...
            <div class="w-56 flex justify-center items-center {{$currentStep <= 4 ? 'block' : 'hidden'}}">
        ...
        <div class="static w-1/12 mt-4 sm:mt-0 flex justify-center pr-6 sm:pr-0 sm:justify-end items-center mainColor">
            <div>
                    <button type="button"  class="{{$currentStep < 4 ? 'block':'hidden'}}" wire:click="nextStep"><i class="fas fa-chevron-right fa-2x sm:fa-4x"></i></button>
            </div>
        </div>
    </div>
</div>
